<!DOCTYPE html>
<html lang="en">
<!--This is the events page designed by bootstrap and programmed using google calendar api - Authors: HAK-->
<head>
  <meta charset="UTF-8">
...
<body>
  ...
  <nav class="navbar navbar-inverse navbar-expand-lg navbar-dark bg-dark">
    ...
    <!-- NAVBAR END -->
		<!-- Calendar -->
		<li class="nav-item">
          <a href="https://calendar.google.com/calendar/u/5/r?tab=oc&pli=1" class="nav-link" target="_blank">See Events on the Calendar</a>   <!-- calender should add HAK -->
        </li>
        <!-- FOOTER -->
    <footer class="bg-dark text-white">
      <div class="container">
        <div class="row">
          <div class="col">
          <p class="lead text-center"><span id="year"></span> &copy; جميع الحقوق محفوظة<a href="https://www.facebook.com/shabab.kafartibnit.sc" style="text-align:center;"><img src="Images/download.png" width="30" height="30"></a></p>
           </div>
         </div>
      </div>
    </footer>
