  ...
  <div class="row">
    <div class="offset-lg-1 col-lg-10" style="min-height:400px;">
      <?php
       ...
       global $ConnectingDB;
       $sql  = "SELECT * FROM posts WHERE id='$SarchQueryParameter'";/*!< a variable that defines an sql statement to get all the news from the posts table in the database where id='$SarchQueryParameter' */
